						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Contract Files</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Contracts</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="m-0">
										...
										<!--end::Menu toggle-->
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_624475cbadbb0">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_624475cbadbb0" data-allow-clear="true">
															<option></option>
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="d-flex flex-wrap flex-stack my-5">
									<!--begin::Heading-->
									<h3 class="fw-bolder my-2">Contract Files
								...
								<div class="row g-6 g-xl-9 mb-6 mb-xl-9">
									...
									<div class="col-md-6 col-lg-4 col-xl-3">
										...
										<div class="card h-100">
											...
											<div class="card-body d-flex justify-content-center text-center flex-column p-8">
												<!--begin::Name-->
												<a href="<?php echo $domain ; ?>contract-files.php" class="text-gray-800 text-hover-primary d-flex flex-column">
													<!--begin::Image-->
													<div class="symbol symbol-60px mb-5">
														<img src="<?php echo $domain ; ?>assets/media/svg/files/pdf.svg" alt="" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="fs-5 fw-bolder mb-2">Contract Reqs..</div>
													<!--end::Title-->
												</a>
												<!--end::Name-->
												<!--begin::Description-->
										...
										<div class="card h-100">
											...
											<div class="card-body d-flex justify-content-center text-center flex-column p-8">
												...
												<a href="<?php echo $domain ; ?>contract-files.php" class="text-gray-800 text-hover-primary d-flex flex-column">
													<!--begin::Image-->
													<div class="symbol symbol-60px mb-5">
														<img src="<?php echo $domain ; ?>assets/media/svg/files/doc.svg" alt="" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
										...
										<div class="card h-100">
											...
											<div class="card-body d-flex justify-content-center text-center flex-column p-8">
												...
												<a href="<?php echo $domain ; ?>contract-files.php" class="text-gray-800 text-hover-primary d-flex flex-column">
													<!--begin::Image-->
													<div class="symbol symbol-60px mb-5">
														<img src="<?php echo $domain ; ?>assets/media/svg/files/css.svg" alt="" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
										...
										<div class="card h-100">
											...
											<div class="card-body d-flex justify-content-center text-center flex-column p-8">
												...
												<a href="<?php echo $domain ; ?>contract-files.php" class="text-gray-800 text-hover-primary d-flex flex-column">
													<!--begin::Image-->
													<div class="symbol symbol-60px mb-5">
														<img src="<?php echo $domain ; ?>assets/media/svg/files/ai.svg" alt="" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
										...
										<div class="card h-100">
											...
											<div class="card-body d-flex justify-content-center text-center flex-column p-8">
												...
												<a href="<?php echo $domain ; ?>contract-files.php" class="text-gray-800 text-hover-primary d-flex flex-column">
													<!--begin::Image-->
													<div class="symbol symbol-60px mb-5">
														<img src="<?php echo $domain ; ?>assets/media/svg/files/sql.svg" alt="" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
										...
										<div class="card h-100">
											...
											<div class="card-body d-flex justify-content-center text-center flex-column p-8">
												...
												<a href="<?php echo $domain ; ?>contract-files.php" class="text-gray-800 text-hover-primary d-flex flex-column">
													<!--begin::Image-->
													<div class="symbol symbol-60px mb-5">
														<img src="<?php echo $domain ; ?>assets/media/svg/files/xml.svg" alt="" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
										...
										<div class="card h-100">
											...
											<div class="card-body d-flex justify-content-center text-center flex-column p-8">
												...
												<a href="<?php echo $domain ; ?>contract-files.php" class="text-gray-800 text-hover-primary d-flex flex-column">
													<!--begin::Image-->
													<div class="symbol symbol-60px mb-5">
														<img src="<?php echo $domain ; ?>assets/media/svg/files/tif.svg" alt="" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
									...
									<div class="col-md-6 col-lg-4 col-xl-3">
										...
										<div class="card h-100 flex-center bg-light-primary border-primary border border-dashed p-8">
											<!--begin::Image-->
											<img src="<?php echo $domain ; ?>assets/media/svg/files/upload.svg" class="mb-5" alt="" />
											<!--end::Image-->
											<!--begin::Link-->
