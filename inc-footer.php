...
<?php //include "inc-drawer-footer.php"; ?>
		...
		<script src="<?php echo $domain ; ?>assets/js/custom/documentation/forms/tagify.min.js"></script>
		<script src="<?php echo $domain ; ?>assets/js/custom/documentation/forms/tagify-user.js"></script>
