						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Note Details</h1>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="m-0">
										...
										<!--end::Menu toggle-->
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_624475dc4d7f2">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_624475dc4d7f2" data-allow-clear="true">
															<option></option>
														...
														<div class="py-0" data-kt-customer-payment-method="row">
															...
															<div class="py-3 d-flex flex-stack flex-wrap">
																...
																<div class="d-flex align-items-center collapsible rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_1" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_1">
																	...
																	<!--end::Arrow-->
																	<!--begin::Logo-->
																	<img src="<?php echo $domain ; ?>assets/media/svg/card-logos/mastercard.svg" class="w-40px me-3" alt="" />
																	<!--end::Logo-->
																	<!--begin::Summary-->
																	<div class="me-3">
																		<div class="d-flex align-items-center">
																		...
																		<table class="table table-flush fw-bold gy-1">
																			...
																			<tr>
																				...
																				<div class="symbol symbol-20px symbol-circle ms-2">
																					<img src="<?php echo $domain ; ?>assets/media/flags/australia.svg" />
																				</div></td>
																			</tr>
																			<tr>
														...
														<div class="py-0" data-kt-customer-payment-method="row">
															...
															<div class="py-3 d-flex flex-stack flex-wrap">
																...
																<div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_2" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_2">
																	...
																	<!--end::Arrow-->
																	<!--begin::Logo-->
																	<img src="<?php echo $domain ; ?>assets/media/svg/card-logos/visa.svg" class="w-40px me-3" alt="" />
																	<!--end::Logo-->
																	<!--begin::Summary-->
																	<div class="me-3">
																		<div class="d-flex align-items-center">
																	...
																	<div class="flex-equal">
																		<table class="table table-flush fw-bold gy-1">
																			...
																			<tr>
																				...
																				<div class="symbol symbol-20px symbol-circle ms-2">
																					<img src="<?php echo $domain ; ?>assets/media/flags/united-kingdom.svg" />
																				</div></td>
																			</tr>
																			<tr>
																				<td class="text-muted min-w-125px w-125px">CVC check</td>
														...
														<div class="py-0" data-kt-customer-payment-method="row">
															...
															<div class="py-3 d-flex flex-stack flex-wrap">
																...
																<div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_3" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_3">
																	...
																	<!--end::Arrow-->
																	<!--begin::Logo-->
																	<img src="<?php echo $domain ; ?>assets/media/svg/card-logos/american-express.svg" class="w-40px me-3" alt="" />
																	<!--end::Logo-->
																	<!--begin::Summary-->
																	<div class="me-3">
																		<div class="d-flex align-items-center">
																	...
																	<div class="flex-equal">
																		<table class="table table-flush fw-bold gy-1">
																			...
																			<tr>
																				...
																				<div class="symbol symbol-20px symbol-circle ms-2">
																					<img src="<?php echo $domain ; ?>assets/media/flags/united-states.svg" />
																				</div></td>
																			</tr>
																			<tr>
																				<td class="text-muted min-w-125px w-125px">CVC check</td>
													...
													<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_address_header" data-kt-scroll-wrappers="#kt_modal_update_address_scroll" data-kt-scroll-offset="300px">
														...
														<div id="kt_modal_update_address_billing_info" class="collapse show">
															...
															<div class="d-flex flex-column mb-7 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<select name="country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a Country..." data-dropdown-parent="#kt_modal_update_address" class="form-select form-select-solid fw-bolder">
													...
													<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_address_header" data-kt-scroll-wrappers="#kt_modal_add_address_scroll" data-kt-scroll-offset="300px">
														...
														<div id="kt_modal_add_address_billing_info" class="collapse show">
															...
															<div class="d-flex flex-column mb-7 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<select name="country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a Country..." data-dropdown-parent="#kt_modal_add_address" class="form-select form-select-solid fw-bolder">
																	<option value="">Select a Country...</option>
																	<option value="AF">Afghanistan</option>
																	<option value="AX">Aland Islands</option>
																	<option value="AL">Albania</option>
											...
											<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
												...
												<div class="fw-bolder d-flex flex-column justify-content-center mb-5">
													...
													<div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
														<img src="<?php echo $domain ; ?>assets/media/misc/qr.png" alt="Scan this QR code" />
													</div>
													<!--end::QR code-->
													<!--begin::Text code-->
