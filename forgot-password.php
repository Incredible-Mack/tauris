...
<html lang="en">
	...
	<body id="kt_body" class="bg-body">
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form">
							...
							<div class="d-flex flex-wrap justify-content-center pb-lg-0">
								...
								<a href="<?php echo $domain ; ?>sign-in.php" class="btn btn-lg btn-light-primary fw-bolder">Cancel</a>
							</div>
							<!--end::Actions-->
						</form>
						<!--end::Form-->
		...
		<!--end::Main-->
		<!--begin::Javascript-->
		<script>var hostUrl = "<?php echo $domain ; ?>assets/";</script>
		...
		<script src="<?php echo $domain ; ?>assets/js/custom/authentication/password-reset/password-reset.js"></script>
